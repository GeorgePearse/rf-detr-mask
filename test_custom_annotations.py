...
def test_custom_annotations():
    ...
    try:
        ...
        print(f"✓ Train dataset with absolute path loaded successfully with {len(train_dataset_abs)} samples")
    except Exception as e:
    ...
    try:
        ...
        print(f"✓ Default train dataset loaded successfully with {len(train_dataset_default)} samples")
    except Exception as e:
