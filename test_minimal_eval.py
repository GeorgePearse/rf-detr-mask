...
def test_mlp_dtype():
    ...
    sine_embed_float32 = gen_sineembed_for_position(pos_tensor_float32, dim=128)  # Returns 512 dims for 4D input
    print(f"Float32 - Pos tensor dtype: {pos_tensor_float32.dtype}, Sine embed dtype: {sine_embed_float32.dtype}")
    ...
    print(f"Float16 - Pos tensor dtype: {pos_tensor_float16.dtype}, Sine embed dtype: {sine_embed_float16.dtype}")
