...
class TrainingConfig(BaseModel):
    ...
    early_stopping_patience: int = Field(5, description="Number of validations with no improvement before stopping")
    early_stopping_min_delta: float = Field(0.001, description="Minimum change to count as improvement")
    ...
    drop_schedule: Literal["constant", "linear"] = Field("constant", description="Drop schedule type")
    ...
    coco_train: str = Field("2025-05-15_12:38:23.077836_train_ordered.json", description="Training annotation file name")
    coco_val: str = Field("2025-05-15_12:38:38.270134_val_ordered.json", description="Validation annotation file name")
