...
class RFDETRLightningModule(pl.LightningModule):
    ...
    def on_validation_epoch_start(self):
        ...
        self.coco_evaluator = CocoEvaluator(base_ds, iou_types)        # E
    ...
    def on_validation_epoch_end(self):
        ...
        logger.info("Metric calculation will happen here")
    ...
    def configure_optimizers(self):
        ...
        return {
            "optimizer": torch.optim.AdamW(lr=0.0001, weight_decay=0.0001),
            "lr_scheduler": {
