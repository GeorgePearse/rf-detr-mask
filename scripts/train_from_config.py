#!/usr/bin/env python
# ------------------------------------------------------------------------
# RF-DETR-Mask Training Script Using YAML Configuration
# ------------------------------------------------------------------------

"""
Script to train RF-DETR with mask head using YAML configuration.
This script replaces the argparse-based configuration with a YAML configuration file.
"""
...
def get_args_parser():
    parser = argparse.ArgumentParser("Train RF-DETR-Mask using YAML config", add_help=True)
    parser.add_argument(
