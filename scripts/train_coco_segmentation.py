...
def get_args_parser():
    ...
    # Dataset parameters
    parser.add_argument("--coco_path", type=str, required=True, help="Path to the COCO dataset")
    parser.add_argument(
        "--output_dir", default="output_segmentation", help="Path to save logs and checkpoints"
    )

    # Training parameters
    parser.add_argument("--batch_size", default=2, type=int, help="Batch size per GPU")
    parser.add_argument("--epochs", default=12, type=int, help="Number of epochs to train for")
    parser.add_argument("--lr", default=1e-4, type=float, help="Learning rate")
    parser.add_argument(
        "--lr_drop", default=11, type=int, help="Epoch at which to drop learning rate"
    )
    ...
    parser.add_argument(
        "--grad_accum_steps", default=1, type=int, help="Gradient accumulation steps"
    )
    ...
    # Model parameters
    parser.add_argument(
        "--encoder", default="vit_base", type=str, help="Name of the transformer backbone"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--num_classes",
        default=91,
        type=int,  # COCO has 80 classes + 1 background
    ...
    parser.add_argument(
        "--num_workers", default=2, type=int, help="Number of workers for data loading"
    )
    ...
    parser.add_argument(
        "--sync_bn", action="store_true", help="Use synchronized batch normalization"
    )
